# Script para agregar todas las variables de entorno en Vercel
# Uso: .\add-all-env-vars.ps1

Write-Host "🔐 Agregando todas las variables de entorno en Vercel..." -ForegroundColor Cyan

# Cambiar al directorio frontend
Set-Location frontend

# Todas las variables necesarias con sus valores
$envVars = @{
    # Frontend - Públicas (van a production, preview, development)
...
Write-Host "📋 Agregando $($envVars.Count) variables de entorno..." -ForegroundColor Yellow
Write-Host ""
...
foreach ($key in $envVars.Keys) {
    ...
    # Agregar la variable usando echo para pasar el valor
